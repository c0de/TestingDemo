...
public static class DbContextExtensions
{
    ...
    public static async Task<DatabaseObjectSyncResult> SyncStoredProceduresAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        return await syncService.SyncStoredProceduresAsync(dbContext, assembly, resourceNamespace, cancellationToken);
    }
    ...
    public static async Task<DatabaseObjectSyncResult> SyncSqlObjectsAsync(
        this DbContext dbContext,
        IServiceProvider serviceProvider = null,
        Assembly assembly = null,
        string resourceNamespace = null,
